                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="form-control w-full max-w-md mt-2">
                            ...
                            <input name="judul" type="text" value="{{ old('judul', $buku->judul) }}" placeholder=""
                        ...
                        <label class="form-control w-full max-w-md mt-2">
                            ...
                            <select name="kategori_id" class="select select-bordered text-sm">
                                <option disabled {{ old('kategori_id', $buku->kategori_id) ? '' : 'selected' }}>
                        ...
                        <label class="form-control w-full max-w-md mt-2">
                            ...
                            <input name="deskripsi" type="text" value="{{ old('deskripsi', $buku->deskripsi) }}"
                        ...
                        <label class="form-control w-full max-w-md mt-2">
                            ...
                            <input name="jumlah" type="number" value="{{ old('jumlah', $buku->jumlah) }}"
                                placeholder="" class="input input-bordered w-full max-w-md" />
                            @error('jumlah')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
